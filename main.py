...
def count_down(count):
    ...
    canvas.itemconfig(item_text, text=f"{count_min}:{count_sec}")
    if count > 0:
        global timer
        timer = window.after(1000, count_down, count - 1)
        # To check the count number
        # print("count:",count)
    else:
        start_timer()
        marks = ""
...
item_text = canvas.create_text(100, 130, text="00:00", fill="white", font=(FONT_NAME, 35, "bold"))
